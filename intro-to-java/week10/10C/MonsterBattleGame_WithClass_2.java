...
public class MonsterBattleGame_WithClass_2 {
  public static void main(String[] args) {
    ...
    GameCharacter player   = new Player("Player",   300, 60);
    GameCharacter monster1 = new Monster("Monster1", 100, 20);
    GameCharacter monster2 = new Monster("Monster2", 100, 20);
    GameCharacter monster3 = new Monster("Monster3", 100, 20);
