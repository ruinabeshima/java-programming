...
public class LinePatternDemo extends JFrame{

    // Constructor of LinePatternDemo
    public LinePatternDemo(){
        setSize(800,800);                                // Set the window size
        setLocation(50,150);                             // Set the window position
        setTitle("Java Programing LinePatternDemo");     // Set the window title
    ...
    public static void main(String[] args){
        new LinePatternDemo();   // Create the LinePatternDemo window
    }
